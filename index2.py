...
app.layout = dbc.Container(children=[
    ...
    dbc.Row([
            ...
            dbc.Card([
                dbc.CardBody([
                    dbc.Row([
                        ...
                        dbc.Col([        
                            html.I(className='fa fa-balance-scale', style={'font-size': '200%','margin-right':'20px'})
                    ...
                    dbc.Row([
                        dbc.Button("Visite o Site", href="https://www.linkedin.com/in/joao-victor-prezotto-a804231b1/", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card),

        ], sm=12, lg=2, style={'margin-top': '7px', 'height':'100%'}),
        ...
        ], sm=12, lg=7,style={'margin-top': '7px'}),
                        ...
                        dbc.Row(
                            dbc.Col([
                                ...
                                dbc.RadioItems(
                                    ...
                                    html.Div(id='month-select', style={'text-align': 'center', 'margin-top': '15px'}, className='dbc'),
                                    html.Hr(),
    ...
    ], className='g-2', style={'margin-top': '7px', 'display': 'flex', 'align-items': 'stretch'}),
...
], fluid=True, style={'minHeight': '100vh', 'overflowY': 'auto', 'paddingBottom': '20px'})
...
def graph1(month, toggle):
    ...
    select = html.H1(convert_to_text(month),style={'fontSize': '2.5vw'})
